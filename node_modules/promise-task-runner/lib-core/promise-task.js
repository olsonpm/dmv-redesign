...
function PromiseTask() {
    ...
    this.task = function task(task_) {
        ...
        if (typeof task_ !== 'undefined') {
            ...
            // task needs to be a singleton during task execution.  We accomplish this by setting a separate variable
            //   (_taskResult) while task is being run.  If _taskResult is not set, that implies the task has not yet 
            ...
            my.task = function() {
                ...
                // after task is run, we no longer need to cache its result.  Doing so causes other undesirable side-effects.
